...
st.title("📦 Prediksi Segmen Pelanggan Superstore Baru")
...
def plot_pca_clusters(pca_data_historis, new_point=None, predicted_cluster=None):
    ...
    ax.set_xlabel('Principal Component 1 (PC1 - Sales)', fontsize=12)
    ax.set_ylabel('Principal Component 2 (PC2 - Profit)', fontsize=12)
